...
function RegisterU() {
    ...
    const {registerInfo, UpdateInfo, registerUser, RegisterError,isRegisterLoading} = useContext(AuthContext)
        ...
        <div className="p-5 bg-white md:flex-1">
            ...
            <div className="flex -mx-3">
                <div className="w-1/3 px-3">
                    <label className="text-xs font-semibold px-1">Id. Type</label>
                    <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                ...
                <div className="w-2/3 px-3">
                    <label className="text-xs font-semibold px-1">Id. Number</label>
                        <div className="flex">
                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                            <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-300 outline-none focus:border-indigo-500" placeholder="Smith"
                            onChange={(e)=>
            ...
            <div>
              <button
                ...
                {isRegisterLoading ? "Creating your account" : "Register Now"} 
              </button>
              {
